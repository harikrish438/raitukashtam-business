package com.raitukashtam.mycommunity.filter;
...
public class RequestLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        logger.info("=== MYCOMMUNITY SERVICE REQUEST START ===");
        ...
        try {
            ...
            logger.info("=== MYCOMMUNITY SERVICE REQUEST END ===");
            logger.info("Method: {}, Path: {}, Status: {}", method, path, response.getStatus());
        } catch (Exception e) {
            logger.error("=== MYCOMMUNITY SERVICE REQUEST ERROR ===");
